                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 text-center mx-auto">
                            ...
                            $id=$_REQUEST['id'];
                                $obj_alumno=new materia("","","");
                                echo "<h3 class='hero-title text-center mb-4 pb-2'>CURSO ELIMINADO</h3>";
                                $obj_alumno->eliminar($id);
                                ?>
                                <br>
                            <a class="custom-btn btn mt-4" href="../listados/listado_materias.php">Volver al listado</a>
                        </div>
                    </div>
                </div>
            </section>
