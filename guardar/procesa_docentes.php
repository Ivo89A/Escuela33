            ...
            <section class="hero-section hero-bg d-flex justify-content-center align-items-center">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 text-center mx-auto --bs-light style='background-color:white'">
                            <?php
                                include("../class/clase_docente.php");
                                $ape=$_REQUEST['apellido'];
                                $nom=$_REQUEST['nombre'];
                                $mail=$_REQUEST['mail'];
                                $obj_docente=new docente($ape,$nom,$mail);
                                echo "<h3 class='hero-title text-center mb-4 pb-2'>MOSTRANDO OBJETO DOCENTE CREADO:</h3>";
                                echo $obj_docente->apellido;
                                echo "<br>";
                                echo $obj_docente->nombre;
                                echo "<br>";
                                echo $obj_docente->mail;
                                echo "<br>";
                            
                                $obj_docente->guardar();
                                echo "<br>Docente guardado en la Base de Datos";
                                ?>
                                <br>
                            <a class="custom-btn btn mt-4" href="../listados/listado_docentes.php">Volver</a>
                        </div>
                    </div>
                </div>
            </section>
