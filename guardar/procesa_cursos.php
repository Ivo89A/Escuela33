                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 text-center mx-auto --bs-light style='background-color:white'">
                            <?php
                                ...
                                $nom=$_REQUEST['nombre_curso'];
                                $tur=$_REQUEST['turno'];
                                $au=$_REQUEST['aula'];
                                $obj_curso=new curso($nom,$tur,$au);
                                echo "<h3 class='hero-title text-center mb-4 pb-2'>MOSTRANDO OBJETO CURSO CREADO:</h3>";
                                ...
                                ?>
                                <br>
                            <a class="custom-btn btn mt-4" href="../listados/listado_cursos.php">Volver</a>
                        </div>
                    </div>
                </div>
            </section>
