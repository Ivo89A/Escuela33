                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-12 col-12 d-flex">
                            ...
                            <ul class="social-icon d-flex justify-content-center align-items-center mx-auto">
                                <span class="text-white me-4 d-none d-lg-block">Estamos en:</span>
            ...
            <section class="hero-section hero-bg d-flex justify-content-center align-items-center">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 text-center mx-auto background-color:white'">
                            <?php
                                include("../class/clase_calificacion.php");
                                $idalumno=$_REQUEST['apellido'];
                                $idmateria=$_REQUEST['materias'];
                                $nota1=$_REQUEST['nota1'];
                                $obj_calificacion=new Calificacion( $idalumno, $idmateria, $nota1);
                                echo "<h3 class='hero-title text-center mb-4 pb-2'>MOSTRANDO OBJETO CALIFICACION CREADO:</h3>";
                                echo $obj_calificacion->idalumno;
                                echo "<br>";
                                echo $obj_calificacion->idmateria;
                                echo "<br>";
                                echo $obj_calificacion->nota1;
                                echo "<br>";
                                $obj_calificacion->guardar();
                                echo "<br>Calificacion guardada en la Base de Datos";
                                ?>
                                <br>
                            <a class="custom-btn btn mt-4" href="../registrar_calificacion.php">Volver</a>
                        </div>
                    </div>
                </div>
            </section>
