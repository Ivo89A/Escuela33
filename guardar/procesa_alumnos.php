                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 text-center mx-auto --bs-light style='background-color:white'">
                            <?php
                                ...
                                $nom=$_REQUEST['nombre'];
                                $sexo=$_REQUEST['sexo'];
                                $fec=$_REQUEST['fecha_nacimiento'];
                                $obj_alumno=new alumno($ape,$nom,$sexo,$fec);
                                echo "<h3 class='hero-title text-center mb-4 pb-2'>MOSTRANDO OBJETO ALUMNO CREADO:</h3>";
                                echo $obj_alumno->apellido;
                                echo "<br>";
                                echo $obj_alumno->nombre;
                                echo "<br>";
                                echo $obj_alumno->sexo;
                                echo "<br>";
                                ...
                                ?>
                                <br>
                            <a class="custom-btn btn mt-4" href="../listados/listado_alumnos.php">Volver</a>
                        </div>
                    </div>
                </div>
            </section>
