                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12 text-center mx-auto background-color:white'">
                            <?php
                                ...
                                $nombre_mat=$_REQUEST['nombre_materia'];
                                $iddoc=$_REQUEST['iddocente'];
                                $obj_materia=new materia($idmateria,$nombre_mat,$iddoc);
                                echo "<h3 class='hero-title text-center mb-4 pb-2'>MOSTRANDO OBJETO MATERIA CREADO:</h3>";
                                echo $obj_materia->nombre_materia;
                                echo "<br>";
                                echo $obj_materia->iddocente;
                                echo "<br>";
                                $obj_materia->guardar();
                                echo "<br>Materia guardada en la Base de Datos";
                                ?>
                                <br>
                            <a class="custom-btn btn mt-4" href="../listados/listado_materias.php">Volver</a>
                        </div>
                    </div>
                </div>
            </section>
